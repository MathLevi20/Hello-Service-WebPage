...
import './index.css'
import iphone from './assets/mediamodifier_image.png'
function App() {
      ...
      <section className="text-black bg-[#F8ED31] body-font px-20">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            <img className="object-cover object-center rounded transform transition-all hover:scale-125" alt="hero" src={iphone} />
          </div>
        </div>
      </section>
